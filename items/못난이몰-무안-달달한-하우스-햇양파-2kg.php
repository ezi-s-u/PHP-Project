...
<head>
  ...
  <title>못난이몰 무안 달달한 하우스 햇양파 2kg - 난이몰</title>
</head>
...
<body>
  ...
  <main>
    ...
    $sql = "select * from nanimall where item_name = '못난이몰 무안 달달한 하우스 햇양파 2kg'";
    ...
    <img style="margin:0 auto; display: block; max-width:100%;" src="../images/item-img/onion.jpg">
  </main>
  <footer>
