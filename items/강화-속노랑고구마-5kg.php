...
<body>
  ...
  <main>
    ...
    $sql = "select * from nanimall where item_name = '강화 속노랑고구마 5kg'";
    ...
    <img style="margin:0 auto; display: block; max-width:100%;" src="../images/item-img/ganghwa.jpg">
  </main>
  <footer>
