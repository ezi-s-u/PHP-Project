...
<head>
  ...
  <title>유기농 고구마 못난이 5kg - 난이몰</title>
</head>
...
<body>
  ...
  <main>
    ...
    $sql = "select * from nanimall where item_name = '유기농 고구마 못난이 5kg'";
    ...
    <img style="margin:0 auto; display: block; max-width:100%;" src="../images/item-img/yuginong.png">
  </main>
  <footer>
