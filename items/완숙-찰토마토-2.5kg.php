...
<body>
  ...
  <main>
    ...
    $sql = "select * from nanimall where item_name = '완숙 찰토마토 2.5kg'";
    ...
    <img style="margin:0 auto; display: block; max-width:100%;" src="../images/item-img/tomato.png">
  </main>
  <footer>
