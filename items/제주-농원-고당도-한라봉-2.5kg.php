...
<head>
  ...
  <title>제주 농원 고당도 한라봉 2.5kg - 난이몰</title>
</head>
...
<body>
  ...
  <main>
    ...
    $sql = "select * from nanimall where item_name = '제주 농원 고당도 한라봉 2.5kg'";
    ...
    <img style="margin:0 auto; display: block; max-width:100%;" src="../images/item-img/jeju.jpg">
  </main>
  <footer>
