...
<body>
  ...
  <main>
    ...
    $sql = "select * from nanimall where item_name = '달콤한 햇사과 부사'";
    ...
    <img style="margin:0 auto; display: block; max-width:100%;" src="../images/item-img/sweetapple.png">
  </main>
  <footer>
