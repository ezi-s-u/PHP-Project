...
<head>
  ...
  <title>수제청 스틱과일청 5종 10종 선물세트 홈카페 답례품 - 난이몰</title>
</head>
...
<body>
  ...
  <main>
    ...
    $sql = "select * from nanimall where item_name = '수제청 스틱과일청 5종 10종 선물세트 홈카페 답례품'";
    ...
    <img style="margin:0 auto; display: block; max-width:100%;" src="../images/item-img/sujechung.png">
  </main>
  <footer>
